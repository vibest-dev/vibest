...
export const Route = createFileRoute("/session/$sessionId")({
  ...
  loader: async ({ context, params, deps }) => {
    ...
    // Cold load (bookmark, reload, server restart). This starts no agent: it
    // validates the ref, records the project's cwd on the session, and asks
    // the harness whether the native session is still there. A session whose
