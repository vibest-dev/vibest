...
export const CreateSessionInputSchema = Schema.Struct({
  ...
  // Session-scoped config the server seeds at open time via
  // applyInitialSessionConfig. `permissionMode` is an outward id from the
  // harness's negotiated capabilities.
