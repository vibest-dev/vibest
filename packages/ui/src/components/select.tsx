...
function Select<T extends SelectPrimitive.CollectionItem>(props: SelectPrimitive.RootProps<T>) {
  return <SelectPrimitive.Root {...props} />;
}

function SelectClearTrigger({ className, ...props }: SelectPrimitive.ClearTriggerProps) {
  return (
  ...
  return (
    <SelectPrimitive.Positioner>
      <SelectPrimitive.Content
        className={cn(
          "border-input bg-popover text-popover-foreground relative w-full min-w-32 overflow-hidden rounded-md border p-1 shadow-lg",
...
function SelectControl({ className, ...props }: SelectPrimitive.ControlProps) {
  return (
    <SelectPrimitive.Control
      className={cn(
        "border-input focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:border-destructive has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 relative flex min-h-[38px] rounded-md border text-sm transition-[color,box-shadow] outline-none focus-within:ring-[3px]",
        className,
      )}
      {...props}
    />
...
function SelectItemGroupLabel({ className, ...props }: SelectPrimitive.ItemGroupLabelProps) {
  return (
