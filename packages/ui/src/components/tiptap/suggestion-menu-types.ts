...
> {
  ...
  /**
   * Reference the menu anchors to. Defaults to the caret (cursor decoration) —
   * the Notion-style at-cursor popup. Pass the input container element, or a
   * getter for its rect, to anchor full-width above/below the whole input.
   */
