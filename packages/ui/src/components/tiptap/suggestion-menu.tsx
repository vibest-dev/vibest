  ...
  useEffect(() => {
    ...
    const suggestion = Suggestion({
      ...
      command({ editor: commandEditor, range, props }) {
        ...
        const { view, state } = commandEditor;
        const { selection } = state;

        const isMention = commandEditor.extensionManager.extensions.some((extension) => {
        ...
        props.onSelect({ editor: commandEditor, range: rangeToUse, context: props.context });
      },
